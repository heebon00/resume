...
export const HERO = {
  ...
  buttons: [
    ...
    {
      label: "RESUME",
      href: "https://drive.google.com/file/d/1iXUHm9LUT8FaO0NP30Q7EO0pKvD2L0Ls/view?usp=sharing",
    },
...
/* --- MY DESIGN (20:1295) ------------------------------------------------ */
export const DESIGN = {
  // 요청으로 잠시 숨긴다 — 2026-10-01 에 다시 연다. false 로 바꾸면 데스크톱·모바일
  // 섹션, 두 메뉴의 Design 항목, 데스크톱 캔버스 좌표(App.jsx)가 전부 원래대로 돌아온다.
  hidden: true,
  heading: "— MY Design",
