 ...
 *   섹션      캔버스 left -11, top 5567(시안 6139 - 572), 1971.2 x 905, 배경 #1E1E1F
...
const ROWS = [
  { top: 5820, cards: SKILLS.cards.slice(0, 4) },
  { top: 6088, cards: SKILLS.cards.slice(4) },
];
  ...
  return (
    <section id="skills" aria-label="MY SKILLS">
      <div
        ...
        style={box({ left: -11, top: 5567, width: 1971.2, height: 905 })}
      />

      <div
        className="absolute flex flex-col items-center gap-8 text-center"
        data-reveal
        style={box({ left: 104.188, top: 5707, width: 1740.824, height: 65 })}
      >
